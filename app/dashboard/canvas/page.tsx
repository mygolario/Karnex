  ...
  const cards = [
    {
      title: "مشکلات مشتری",
      icon: AlertTriangle,
      content: plan.leanCanvas.problem,
    ...
    },
    {
      ...
      icon: Lightbulb,
      content: plan.leanCanvas.solution,
      color: "text-blue-500",
      bg: "bg-blue-50",
    ...
    },
    {
      title: "ارزش پیشنهادی",
      icon: Gem,
      content: plan.leanCanvas.uniqueValue,
    ...
    },
    {
      title: "جریان درآمدی",
      icon: Banknote,
      content: plan.leanCanvas.revenueStream,
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
        {cards.map((card, idx) => (
          <div 
            key={idx} 
            className={`p-6 rounded-2xl border ${card.border} ${card.bg} relative group overflow-hidden transition-all hover:shadow-md`}
          >
