...
const steps = [
  {
    number: "۱",
    icon: Compass,
    title: "ثبت‌نام و پروفایل",
    description: "بعد از ثبت‌نام، پروفایل راه‌اندازی را پر کنید تا دستیار و طرح دقیقاً برای شما تنظیم شود.",
    color: "from-primary to-pink-600",
    visual: {
      items: ["نقش", "صنعت", "اهداف"],
      highlight: 0,
    },
  },
  {
    ...
    description: "مسیر، جزئیات و ایده را با پیش‌نمایش زنده طرح وارد کنید — بودجه و مخاطب هم مهم است.",
    color: "from-secondary to-yellow-500",
    visual: {
      items: ["مسیر", "نام پروژه", "ایده"],
      highlight: 1,
    },
  },
  {
    number: "۳",
    icon: Map,
    title: "آشکارسازی + مأموریت",
    description: "طرح AI را ببینید، مأموریت‌ها را انجام دهید و XP بگیرید — بعد وارد داشبورد شوید.",
    color: "from-startup to-purple-600",
    visual: {
      items: ["نقشه راه", "بوم", "مأموریت‌ها"],
      highlight: 0,
    },
  },
  {
    number: "۴",
    icon: TrendingUp,
    title: "رشد در داشبورد",
    description: "با ابزارهای تخصصی، تورهای تعاملی و دستیار AI گام به گام پیش بروید.",
    color: "from-traditional to-emerald-600",
    visual: {
      items: ["📈 XP", "🎯 مأموریت", "🤖 Copilot"],
      highlight: 0,
    },
  },
];
