...
export function FeedbackWidget() {
  ...
  const FloatingButton = (
    <button
      ...
      className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-gradient-to-br from-primary to-purple-600 text-white rounded-full shadow-lg shadow-primary/30 flex items-center justify-center hover:scale-110 transition-transform animate-in slide-in-from-bottom-4"
      title="ارسال بازخورد"
    >
