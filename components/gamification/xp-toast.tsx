        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-8 start-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-slate-900 border border-amber-500/30 text-white px-4 py-3 rounded-full shadow-xl shadow-amber-500/10 backdrop-blur-md"
                >
