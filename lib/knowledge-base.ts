...
export const roadmapTaskGuides: Record<string, TaskGuide> = {
  ...
  "tax_registration": {
    ...
    difficulty: "medium",
    timeEstimate: "۵-۷ روز",
    tips: [
      "حتی در صورت عدم تراکنش، عدم ارسال اظهارنامه جریمه دارد",
...
export function findGuideForStep(stepText: string): TaskGuide | null {
  const keywords: Record<string, string[]> = {
    ...
    "trade_license": ["جواز", "جواز کسب", "پروانه کسب", "اتحادیه"],
    "tax_registration": ["مالیات", "پرونده مالیاتی", "کد اقتصادی", "کد اقتصادی/مالیات", "my.tax.gov.ir"],
    "social_security": ["بیمه", "تأمین اجتماعی", "کد کارگاهی", "بیمه/تأمین اجتماعی"],
    "municipality_permits": ["شهرداری", "مجوز تابلو", "پروانه شهرداری", "عوارض"]
  };
...
// ============================================
// COMPLIANCE PHASE FOR TRADITIONAL BUSINESSES
// (moved out of the hook — now data-driven)
// ============================================
import type { RoadmapPhase } from "@/lib/db";

export const traditionalCompliancePhase: RoadmapPhase = {
  ...
  steps: [
    {
      title: "دریافت جواز کسب",
      description:
        "مجوز رسمی برای فعالیت صنفی در مکان تجاری. از درگاه ملی مجوزها اقدام کنید.",
      estimatedHours: 40,
      priority: "high",
      category: "legal",
      status: "todo",
    ...
    },
    {
      title: "ثبت‌نام پرونده مالیاتی و کد اقتصادی",
      description:
        "هر کسب‌وکار فعال موظف به ثبت پرونده مالیاتی در سازمان امور مالیاتی است.",
      estimatedHours: 10,
      priority: "medium",
      category: "legal",
      status: "todo",
    ...
    },
    {
      title: "دریافت کد کارگاهی تأمین اجتماعی",
      description:
        "برای بیمه کردن کارکنان، باید برای کارگاه یا مغازه کد بیمه تأمین اجتماعی بگیرید.",
      estimatedHours: 20,
      priority: "high",
      category: "legal",
      status: "todo",
    ...
    },
    {
      title: "دریافت مجوز تابلوی شهرداری و پروانه‌های محلی",
      description:
        "برای نصب تابلو در فضای عمومی یا تغییرات محلی نیاز به پروانه شهرداری منطقه خود دارید.",
      estimatedHours: 15,
      priority: "medium",
      category: "legal",
      status: "todo",
